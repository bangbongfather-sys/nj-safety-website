...
export const IcChat = ({ size = 17, stroke = 'currentColor' }: P) => (
  <svg {...base(size)} stroke={stroke}><path d="M14 9.5A1.5 1.5 0 0 1 12.5 11H5.5L3 13V3.5A1.5 1.5 0 0 1 4.5 2h8A1.5 1.5 0 0 1 14 3.5z" /></svg>
);
